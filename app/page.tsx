...
import { ArrowRight, BarChart3, Users, Zap, Shield, Cloud, Sparkles } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <nav className="flex items-center justify-between p-6 md:p-8 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl text-slate-50">Nexus ERP</span>
        </div>
      ...
      <section className="py-20 md:py-32 px-6 max-w-7xl mx-auto">
        <div className="text-center space-y-8 mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-slate-50 leading-tight">Enterprise ERP Reimagined</h1>
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <h3 className="font-bold text-slate-50 mb-2">{feature.title}</h3>
      ...
      <section className="py-20 px-6 border-t border-slate-800">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl font-bold text-slate-50">Ready to Transform Your Business?</h2>
